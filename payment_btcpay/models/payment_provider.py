...
class PaymentProvider(models.Model):
    ...
    btcpay_token = fields.Char(string='Token', help='Access Token to BTCPay. Leave empty, will be autogenerated during pairing.', readonly=True, store=True)
    btcpay_privateKey = fields.Text(string='Private Key', help='Private Key for BTCPay Client. Leave empty, will be autogenerated during pairing.', readonly=True, store=True)
