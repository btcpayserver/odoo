...
class BTCPayController(http.Controller):
    ...
    @http.route(_notify_url, type='json', auth='public', methods=['POST'], csrf=False)
    def btcpay_ipn(self, **post):
        ...
        except ValidationError as error:  # Acknowledge rejected notifications without retries.
